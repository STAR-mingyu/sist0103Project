...
public class SwingJdbcScore extends JFrame implements ActionListener {
	...
	public void insertData() {
		...
		double avg = tot / 3.0;
		String sql = "insert into stuinfo2 values(seq_1.nextval,?,?,?,?,?,?,?)";
	...
	// delete
	public void deleteDate(String num) {
		...
		try {
			...
			if (a == 0) {
				JOptionPane.showConfirmDialog(this, "없는 데이타 번호입니다");
			} else {
				tableWrite();
			}
	...
	public void updateData() {
		...
		String sql = "update stuinfo2 set name=?,java=?,jsp=?,spring=?,total=" + tot + ",average=" + avg
				+ ",ban=? where num=?";
...
//			System.out.println("add");
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		SwingJdbcScore score = new SwingJdbcScore("학생성적관리DB");
