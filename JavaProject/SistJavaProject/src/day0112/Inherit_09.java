...
public class Inherit_09 {
	...
	public static void main(String[] args) {
		...
		//자식클래스로 선언
		System.out.println("1.Red로 선언하고 Red로 선언한 경우");
		Red red = new Red();
		red.hello();
		red.process();
		
		System.out.println("2.Green로 선언하고 Green로 선언한 경우");
		Green green = new Green();
		green.hello();
		green.process();
		
		System.out.println("3.Blue로 선언하고 Blue로 선언한 경우");
		Blue blue = new Blue();
		blue.hello();
		blue.process();
		
		System.out.println("4.Pink로 선언하고 Pink로 선언한 경우");
		Pink pink = new Pink();
		pink.hello();
		pink.process();
