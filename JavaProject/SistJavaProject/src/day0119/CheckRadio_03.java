...
public class CheckRadio_03 extends JFrame implements ActionListener, ItemListener {
	...
	public void ininDesign() {
		...
		lblResult = new JLabel("Hava a Nice Day!!!", JLabel.CENTER);
		...
		boldChek = new JCheckBox("굴꼴굵게");
		boldChek.setBounds(120, 20, 200, 30);
		boldChek.setOpaque(false);
		boldChek.addItemListener(this);
		this.add(boldChek);
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if (ob == boldChek) {
			if (boldChek.isSelected() == true) {
				lblResult.setFont(new Font("궁서체", Font.BOLD, 20));
			} else {
