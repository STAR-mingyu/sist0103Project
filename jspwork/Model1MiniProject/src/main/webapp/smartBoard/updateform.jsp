...
<script type="text/javascript"
	src="<%=root%>/se2/photo_uploader/popup/jindo.min.js" charset="utf-8"></script>
		...
		<table style="width: 800px; margin-left: 100px;">
			...
			<tr>
				...
				<td><input type="text" name="writer" class="form-control"
					required="required" style="width: 130px;" value="<%=dto.getWriter()%>"></td>
			</tr>
			<tr>
				<th width="100" class="table-light">제목</th>
				<td><input type="text" name="subject" class="form-control"
					required="required" style="width: 500px;" value="<%=dto.getSubject()%>"></td>
			</tr>
			<tr>
				<td colspan="2"><textarea name="content" id="content" required="required"
