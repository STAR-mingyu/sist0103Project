	...
	<div style="margin: 50px 100px; width: 600px;">
		<form action="shop/addAction.jsp" method="post"
			...
			<table class="table table-bordered">
				...
				<tr>
					<td style="width: 150px;" class="table-light"><b>상품 이미지</b></td>
					<td><input type="file" name="photo" class="form-control"
						style="width: 300px;"></td>
				</tr>
				<tr>
					<td style="width: 150px;" class="table-light"><b>상품 가격</b></td>
					<td><input type="text" name="price" class="form-control"
						style="width: 120px;" required="required" placeholder="가격 입력"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" align="center">
						...
						<button type="button" class="btn btn-info" style="width: 100px;"
							onclick="location.href='index.jsp?main=shop/shopList.jsp'">상품
							목록</button>
					</td>
				</tr>
			</table>
