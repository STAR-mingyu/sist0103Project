			...
			<table class="table table-bordered" style="width: 500px">
				...
				<tr>
					...
					<td colspan="4">
						...
						style="width: 30px" name="image"> <%
							 ...
							 %> <br> <%
							 for (int i = 1; i <= 10; i++) {
							 %> <img alt="" src="../image/avata/b<%=i%>.png" style="width: 30px">
						<%
						}
						%>
					</td>
				...
				<tr>
					<td colspan="4"><textarea rows="" cols=""
							style="width: 530px; height: 100px" name="content"
							class="form-control"><%=dto.getContent()%></textarea></td>
				</tr>

				<tr>
					<td colspan="4" align="center"><input type="hidden" name="num"
						value="<%=num%>"> <input type="submit" value="저장"
						class="btn btn-outline-primary" style="width: 100px"> <input
						type="text" value="방명록" onclick="location.href='guestList.jsp'"
						class="btn btn-outline-primary" style="width: 100px"></td>
				</tr>
