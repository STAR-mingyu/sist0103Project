		...
		<form action="updateAction.jsp" method="post" name="frm">
			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td><select name="blood" class="form-control"
						style="width: 100px;">
							...
							<option value="AB"
								<%=dto.getBlood().equals("AB") ? "selected" : ""%>>AB형</option>
					</select></td>
				</tr>
				...
				<tr>
					...
					<td class="d-inline-flex"><select name="hp1"
					...
					</select> <b>-</b> <input type="text" name="hp2" required="required"
						class="form-control" style="width: 100px;" onkeyup="goFocus(this)"
						value="<%=hp2%>"> <b>-</b> <input type="text" name="hp3"
				...
				<tr>
					<td colspan="2" align="center"><input type="submit" value="수정"
						class="btn btn-outline-warning"> <input type="button"
