...
public class UploadBoardDao {
	...
	// 삭제
	public UploadBoardDto delete(String num) {
		UploadBoardDto dto = new UploadBoardDto();
		Connection conn = db.getConnection();
		PreparedStatement pstmt = null;
	...
	// 수정할때 num과 pass 받아서 비번이 같으면 true,틀리면 false
	public boolean inEqualpass(String num, String pass) {
		boolean b = false;
		Connection conn = db.getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
