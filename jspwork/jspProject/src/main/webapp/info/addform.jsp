...
<td>
<input type="text" name="name" required="required" class="form-control" style="width:120;" placeholder="이름">
</td>
</tr>
<tr>
<th class="table-success" width="80">주소</th>
<td>
<input type="text" name="addr" required="required" class="form-control" style="width:120;" placeholder="주소">
</td>
</tr>
<tr>
